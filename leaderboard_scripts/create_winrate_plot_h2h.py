...
if True:
    datasets = ["BBBP", "BACE", "ClinTox", "FreeSolv", "ESOL", "Lipo"]
    splits = [0, 1, 2, 3, 4]
    data_folder = "battles"
...
os.makedirs("plots/h2h/", exist_ok=True)
...
for dataset in datasets:
    ...
    plt.xlabel("Model 2")
    plt.tight_layout()
    plt.savefig(f"plots/h2h/{dataset}_winrate.png")
...
if len(datasets) > 1:
    ...
    plt.xlabel("Model 2")
    plt.tight_layout()
    plt.savefig(f"plots/h2h/overall_winrate.png")
